...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // /sobre, /contato, /avaliacoes, /atendimento/* e /politica-de-privacidade estão
  // noindex (evitar conteúdo duplicado com marciofranca.adv.br), por isso não entram no sitemap.
