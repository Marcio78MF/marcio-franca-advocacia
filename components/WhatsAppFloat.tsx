...
export default function WhatsAppFloat() {
  ...
  return (
    <div className={`${styles.wrapper} ${visivel ? styles.visivel : ''}`}>
      <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className={styles.btn} aria-label="Falar no WhatsApp" id="whatsapp-float-btn" onClick={trackWhatsapp}>
