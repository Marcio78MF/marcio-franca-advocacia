...
export const POSTS_MOCK = [
  {
    id: '1',
    titulo: 'BPC/LOAS negado: o que fazer?',
    slug: 'bpc-loas-negado-o-que-fazer',
    resumo: 'Entenda os motivos comuns de negativa do BPC/LOAS pelo INSS e quais caminhos podem ser avaliados para buscar a revisão da decisão.',
    categoria: 'Previdenciário',
    publicado: true,
    criadoEm: '2026-05-10',
    conteudo: `## O que é o BPC/LOAS?

O Benefício de Prestação Continuada (BPC) é um direito previsto na Constituição Federal e regulamentado pela Lei Orgânica da Assistência Social (LOAS). Ele garante o pagamento de um salário mínimo mensal a:
...
O INSS pode negar o BPC/LOAS por diversos motivos, como:

- Renda familiar per capita acima do limite legal
- Laudo pericial que não reconhece a deficiência
- Falta de documentação adequada
- CadÚnico desatualizado ou com informações incompletas

## O que fazer após a negativa?

Após receber a negativa, algumas possibilidades podem ser avaliadas:

1. **Recurso Administrativo** – É possível recorrer da decisão dentro do próprio INSS.
2. **Nova documentação** – Reunir laudos e documentos mais detalhados para fortalecer o pedido.
3. **Orientação jurídica** – Buscar análise profissional para avaliar o caso concreto.

> Cada situação é única e depende da análise dos documentos e circunstâncias individuais.

## Perguntas Frequentes

**Preciso pagar para ter direito ao BPC?**
Não. O BPC é um benefício assistencial que não exige contribuição ao INSS.

**Posso receber BPC e Bolsa Família ao mesmo tempo?**
Há regras específicas sobre acumulação de benefícios que devem ser verificadas para cada caso.

---

*${SITE_CONFIG.avisoConteudo}*`,
  },
  {
    id: '2',
    titulo: 'Aposentadoria rural: quais documentos servem como prova?',
    slug: 'aposentadoria-rural-quais-documentos-servem-como-prova',
    resumo: 'Conheça os documentos que podem ser utilizados para comprovar atividade rural e as possibilidades quando não há documentação formal.',
    categoria: 'Previdenciário',
    publicado: true,
    criadoEm: '2026-05-15',
    conteudo: `## A importância da prova documental

Para a aposentadoria por idade rural, é necessário comprovar o exercício de atividade rural por no mínimo 15 anos. O INSS aceita diversos tipos de documentos como início de prova material.

## Documentos aceitos

- Certidão de casamento com profissão de lavrador
- Título de eleitor com profissão de agricultor
- Bloco de notas de produtor rural
- Declaração do Sindicato dos Trabalhadores Rurais
- Contratos de arrendamento ou parceria
- Documentos do INCRA
- Comprovante de participação no Pronaf ou DAP
- ITR (Imposto Territorial Rural) em nome da família

## E se não tenho documentos?

A jurisprudência admite que a prova testemunhal pode complementar a documentação existente. Contudo, é necessário que exista ao menos um início de prova material, conforme entendimento dos tribunais.

> A avaliação de quais documentos podem ser utilizados em cada caso depende de análise individualizada.
...
*${SITE_CONFIG.avisoConteudo}*`,
  ...
  {
    id: '3',
    titulo: 'Desconto indevido no benefício do INSS: como identificar?',
    slug: 'desconto-indevido-beneficio-inss-como-identificar',
    resumo: 'Saiba como verificar se há descontos não autorizados em seu benefício do INSS e quais providências podem ser adotadas.',
    categoria: 'Consumidor',
    publicado: true,
    criadoEm: '2026-05-20',
    conteudo: `## O problema dos descontos não reconhecidos

É cada vez mais comum que aposentados e pensionistas identifiquem descontos em seus benefícios que não reconhecem. Esses descontos podem ser decorrentes de empréstimos consignados, cartões de crédito consignados ou seguros que não foram contratados conscientemente.

## Como verificar

1. Acesse o **Meu INSS** (aplicativo ou site)
2. Consulte o extrato de pagamento (HISCRE)
3. Verifique cada desconto listado
4. Compare com contratos que possui

## Providências que podem ser adotadas

- Registrar reclamação no banco responsável pelo desconto
- Protocolar reclamação no Bacen (Banco Central)
- Registrar reclamação no Procon
- Buscar orientação jurídica para avaliar as medidas cabíveis

> A possibilidade de restituição de valores e demais medidas depende da análise do caso concreto.
...
*${SITE_CONFIG.avisoConteudo}*`,
  ...
  {
    id: '4',
    titulo: 'Conta de energia muito alta: quando a cobrança pode ser questionada?',
    slug: 'conta-energia-alta-quando-cobranca-pode-ser-questionada',
    resumo: 'Entenda as situações em que a cobrança de energia pode ser considerada irregular e quais passos podem ser seguidos pelo consumidor.',
    categoria: 'Consumidor',
    publicado: true,
    criadoEm: '2026-05-25',
    conteudo: `## Variações na conta de energia

Existem diversas razões para variações no valor da conta de energia elétrica: mudança de bandeira tarifária, aumento de consumo ou, em alguns casos, possíveis irregularidades na medição ou na cobrança.

## Situações que merecem atenção

- Aumento repentino e expressivo sem mudança nos hábitos de consumo
- Cobrança retroativa por suposta fraude ou irregularidade
- Troca de medidor seguida de aumento significativo
- Cobrança após corte indevido

## O que fazer

1. Solicitar revisão da fatura junto à Energisa
2. Registrar reclamação na ANEEL ou no Procon
3. Guardar todas as faturas e comprovantes de pagamento
4. Buscar orientação jurídica se a questão não for resolvida administrativamente

> A análise sobre a regularidade de uma cobrança depende das circunstâncias específicas de cada caso.
...
*${SITE_CONFIG.avisoConteudo}*`,
  ...
  {
    id: '5',
    titulo: 'Nome negativado indevidamente: quais são seus direitos?',
    slug: 'nome-negativado-indevidamente-quais-sao-seus-direitos',
    resumo: 'Conheça as situações que podem configurar negativação indevida e os passos que o consumidor pode adotar para proteger seu nome.',
    categoria: 'Consumidor',
    publicado: true,
    criadoEm: '2026-06-01',
    conteudo: `## O que é negativação indevida?

A negativação indevida ocorre quando o nome do consumidor é inscrito em cadastros de inadimplentes (SPC, Serasa) de forma irregular — seja por dívida inexistente, já paga, prescrita ou decorrente de fraude.

## Situações comuns

- Dívida já quitada que permanece no cadastro
- Cobrança de valor que não reconhece
- Uso de dados pessoais por terceiros (fraude)
- Falta de notificação prévia ao consumidor

## Direitos do consumidor

O Código de Defesa do Consumidor prevê a proteção contra práticas abusivas e garante o direito à informação. A legislação também estabelece que:

- O consumidor deve ser notificado antes da inscrição
- As informações negativas devem ser excluídas após 5 anos
- A inscrição indevida pode gerar responsabilidade

> A existência de direito à reparação depende da análise do caso concreto.
...
*${SITE_CONFIG.avisoConteudo}*`,
  ...
  {
    id: '6',
    titulo: 'Pensão alimentícia atrasada: quais medidas podem ser tomadas?',
    slug: 'pensao-alimenticia-atrasada-quais-medidas-podem-ser-tomadas',
    resumo: 'Entenda as medidas legais que podem ser adotadas quando há atraso no pagamento da pensão alimentícia.',
    categoria: 'Família',
    publicado: true,
    criadoEm: '2026-06-05',
    conteudo: `## O dever de pagar alimentos

A pensão alimentícia fixada judicialmente é uma obrigação legal. O não pagamento pode gerar consequências previstas na legislação.

## Medidas possíveis

A legislação prevê diferentes instrumentos para a cobrança de pensão alimentícia em atraso:

- **Execução de alimentos** – Processo judicial para cobrança dos valores devidos
- **Penhora de bens e rendimentos** – Bloqueio de valores ou bens do devedor
- **Prisão civil** – Em caso de débito recente (últimos 3 meses + parcelas vincendas)

## Orientações iniciais

1. Reunir comprovantes de que os pagamentos não estão sendo feitos
2. Ter em mãos a decisão judicial que fixou os alimentos
3. Buscar orientação jurídica para avaliar qual medida é mais adequada

> A escolha da medida mais adequada depende das circunstâncias de cada caso e deve ser avaliada por profissional habilitado.
